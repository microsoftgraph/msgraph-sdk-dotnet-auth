namespace Microsoft.Graph.Auth.Test.PublicClient
{
    ...
    public class UsernamePasswordProviderTests
    {
        ...
        public void ShouldCreatePublicClientApplicationWithMandatoryParams()
        {
            ...
            IClientApplicationBase clientApp = UsernamePasswordProvider.CreateClientApplication(clientId);
        ...
        public void ShouldCreatePublicClientApplicationForConfiguredCloud()
        {
            ...
            IClientApplicationBase clientApp = UsernamePasswordProvider.CreateClientApplication(clientId, tenant: testTenant, cloud: AzureCloudInstance.AzureChina);

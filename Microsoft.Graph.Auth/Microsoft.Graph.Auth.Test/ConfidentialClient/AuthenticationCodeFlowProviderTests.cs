namespace Microsoft.Graph.Auth.Test.ConfidentialClient
{
    ...
    [TestClass]
    public class AuthenticationCodeFlowProviderTests
    {
        private TokenCache tokenCache;
        private AuthenticationCodeFlowProvider authCodeFlowProvider;
        ...
        public void Setup()
        {
            ...
            authCodeFlowProvider = new AuthenticationCodeFlowProvider(clientId, redirectUri, new ClientCredential(appSecret), tokenCache, scopes);
        }

        [TestMethod]
        public void AuthenticationCodeFlow_ConstructorWithoutAuthority()
        {
        ...
        [TestMethod]
        public void AuthenticationCodeFlow_ConstructorWithAuthority()
        {
            var authProvider = new AuthenticationCodeFlowProvider(clientId, commonAuthority, redirectUri, new ClientCredential(appSecret), tokenCache, scopes);
        ...
        [TestMethod]
        public async Task AuthenticationCodeFlow_WithNoUserAccountInCache()
        {
        ...
        [TestMethod]
        public async Task AuthenticationCodeFlow_WithUserAccountInCache()
        {
            var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, "http://example.org/foo");
            var expectedAuthResult = MockAuthResult.GetAuthenticationResult(scopes);
